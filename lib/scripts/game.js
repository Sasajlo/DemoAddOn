...
export default class Game {
    ...
    initialize() {
        ...
        for (const player of world.getAllPlayers()) {
            if (player.hasTag("demo_starter_kit"))
                continue;
            const inventory = (_a = player.getComponent("inventory")) === null || _a === void 0 ? void 0 : _a.container;
            inventory === null || inventory === void 0 ? void 0 : inventory.addItem(new ItemStack("demo:info"));
            inventory === null || inventory === void 0 ? void 0 : inventory.addItem(new ItemStack("demo:grappling_hook"));
